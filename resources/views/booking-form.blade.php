    ...
    <div class="container py-md-2">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 py-3 py-md-5">
                <h1 class="display-3">Book a ride</h1>
            ...
            <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5 mx-auto">
                ...
                <form action="/booking-register" method="POST" id="registration-form">
                    @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input value="{{ old('date') }}" name="date" id="date-booking-register"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select name="hour" id="hour-booking-register" class="form-control">
                            ...
                            <option value="10" {{ old('hour') == '10' ? 'selected' : '' }}>10:00</option>
                            <option value="11" {{ old('hour') == '11' ? 'selected' : '' }}>11:00</option>
                            <option value="12" {{ old('hour') == '12' ? 'selected' : '' }}>12:00</option>
                            <option value="13" {{ old('hour') == '13' ? 'selected' : '' }}>13:00</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea name="comment" id="comment-booking-register" class="form-control" placeholder="Any comment...">{{ old('observations') }}</textarea>
                    </div>
